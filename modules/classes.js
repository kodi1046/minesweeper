...
var Grid = /** @class */ (function () {
    ...
    function Grid(row_count, col_count, desired_mine_count) {
        ...
        if (desired_mine_count < 0 || desired_mine_count > row_count * col_count) {
            throw new errors_js_1.InvalidMinesError(desired_mine_count, row_count, col_count);
        }
        this.grid = [];
    ...
    Grid.prototype.get_empty_count = function () {
        var empty_count = this.row_count * this.col_count - this.desired_mine_count;
     ...
     */
    Grid.prototype.flag_all_mines = function () {
        var _this = this;
        var all_indices = this.get_all_indices();
        all_indices.forEach(function (index) {
            if (_this.cell_at(index[0], index[1]).get_type() === "mine") {
                _this.cell_at(index[0], index[1]).set_state("flagged");
            }
        });
    };
    /**
